...
echo "===== Sweep 1: PHT Size (HIST_LEN=10) ====="
echo "PHT entries: 256, 1024, 4096, 16384, 65536"
./compile cbp -DPREDICTOR="two_level_local<8,10>"  && ./cbp ./gcc_test_trace.gz test 1000000 40000000
./compile cbp -DPREDICTOR="two_level_local<10,10>" && ./cbp ./gcc_test_trace.gz test 1000000 40000000
./compile cbp -DPREDICTOR="two_level_local<12,10>" && ./cbp ./gcc_test_trace.gz test 1000000 40000000
./compile cbp -DPREDICTOR="two_level_local<14,10>" && ./cbp ./gcc_test_trace.gz test 1000000 40000000
./compile cbp -DPREDICTOR="two_level_local<16,10>" && ./cbp ./gcc_test_trace.gz test 1000000 40000000

echo ""
echo "===== Sweep 2: History Length (PHT=4096) ====="
...
echo ""
echo "===== Sweep 3: Best Configuration ====="
./compile cbp -DPREDICTOR="two_level_local<12,12>" && ./cbp ./gcc_test_trace.gz test 1000000 40000000 --format human
